...
| Environment variable | Default value | Description |
|----------------------|---------------|-------------|
| HADOOP_HOME          | "${CDH_COMPONENTS_HOME}/${HADOOP_PKG}/" | Used to locate Hadoop |
| HADOOP_INCLUDE_DIR   | "${HADOOP_HOME}/include" | For 'hdfs.h' |
| HADOOP_LIB_DIR       | "${HADOOP_HOME}/lib" | For 'libhdfs.a' or 'libhdfs.so' |
| HIVE_HOME            | "${IMPALA_HOME}/toolchain/cdh_components/${HIVE_PKG}/" | |
| HIVE_SRC_DIR         | "${HIVE_HOME}/src" | Used to find Hive thrift files. |
| HBASE_HOME           | "${IMPALA_HOME}/toolchain/cdh_components/${HBASE_PKG}/" | |
| SENTRY_HOME          | "${CDH_COMPONENTS_HOME}/toolchain/" | |
| THRIFT_HOME          | "${IMPALA_HOME}/toolchain/${THRIFT_PKG}"
